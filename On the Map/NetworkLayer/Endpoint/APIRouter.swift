...
//  Seen
//
//  Created by mahmoud diab on 5/1/20.
...
// Making a Request
 //import Alamofire
    ...
    let x = Alamofire.request("https://httpbin.org/get").responseJSON { response in
...
/*
 ...
 关于 / 活跃会员 / API / Hacker News / tags / 关注我们 / 小专栏
 DiyCode由众多开发者共同维护，致力于构建开发工程师高端交流分享社区。
 图片存储由 又拍云存储 提供。Inspired by RubyChina。 粤ICP备14008250号
 简体中文 / 正體中文 / English
